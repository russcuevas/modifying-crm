...
<script>
	...
	// Function to display the chosen avatar image
	...
	$('#manage-user').submit(function(e){
		...
		$.ajax({
			url: _base_url_+'classes/Users.php?f=save',  // Ensure this URL points to the correct endpoint
			...
			success: function(resp){
				if(resp == 1){
					location.href = './?page=user/list'; // Redirect if successful
				}else{
