							...
							<div class="col-lg-6 col-sm-12">
								<div class="d-flex">
									...
									<div class="col-auto flex-grow-1 flex-shrink-1">
										<p class="m-0 truncate-1"><b><?= $row['code'] ?></b></p>
									</div>
								</div>
								<div class="d-flex">
									<div class="col-auto text-muted pl-3">Client:</div>
									<div class="col-auto flex-grow-1 flex-shrink-1">
										<p class="m-0 truncate-1"><b><?= ucwords($row['client']) ?></b></p>
									</div>
								</div>
								<div class="d-flex">
									<div class="col-auto text-muted pl-3">Email:</div>
									<div class="col-auto flex-grow-1 flex-shrink-1">
										<p class="m-0 truncate-1"><b><?= $row['email'] ?></b></p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-12">
								<div class="d-flex">
									...
									<div class="col-auto flex-grow-1 flex-shrink-1">
										<p class="m-0 truncate-1"><b><?= $row['interested_in'] ?></b></p>
									</div>
								</div>
								<div class="d-flex">
									<div class="col-auto text-muted pl-3">Assigned To:</div>
									<div class="col-auto flex-grow-1 flex-shrink-1">
										<p class="m-0 truncate-1"><b><?= (isset($user_arr[$row['assigned_to']])) ? ucwords($user_arr[$row['assigned_to']]) : "Not Assigned Yet." ?></b></p>
									</div>
								</div>
								<div class="d-flex">
